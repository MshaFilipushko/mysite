...
from .models import Category, Post, Recipe, Challenge, UserProfile, ForumCategory, ForumTopic, ForumPost, Comment, RecipeComment, Notification, VIPPost, VIPComment, ContactMessage
...
from .forms import CustomUserCreationForm as UserRegisterForm, UserProfileForm, CommentForm, UserPostForm, ForumTopicForm, ForumPostForm, RecipeCommentForm, UserRecipeForm, VIPPostForm, VIPCommentForm
import random
import json
import re
import datetime
